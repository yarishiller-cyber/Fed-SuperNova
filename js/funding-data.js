...
const FACETS = {
  dept: ["DoD", "DOE", "Civilian", "Cross-agency", "Private / Alt"],
  mechanism: [
    ...
    "Venture Capital", "Accelerator (equity)", "Crowdfunding",
    "Venture Debt / RBF", "State / Local Grant"
  ],
  capital: ["Non-dilutive", "Debt (non-dilutive)", "Equity (dilutive)", "Rewards / pre-sales"],
...
const PROGRAMS = [
  ...
  {
    id: "defense-vc",
    name: "Defense & Dual-Use Venture Capital",
    funder: "Private VC (a16z, Founders Fund, Lux, 8VC, Shield, Decisive Point)",
    dept: "Private / Alt",
    mechanism: "Venture Capital",
    capital: "Equity (dilutive)",
    award: "$2M–$15M",
    typical: "Seed to growth · checks ~$500K–$50M+ · you give up equity",
    eligibility: "High-growth startup with a defensible technology and a fundable team.",
    tech: ["AI / ML", "Autonomy / UAV", "Space", "RF / Sensors", "Advanced Materials", "Directed Energy"],
    desc: "Private equity capital from firms that specialize in defense and dual-use technology — dilutive, but larger and faster than grants.",
    detail: "A wave of VC firms now invests specifically in defense and dual-use: a16z American Dynamism, Founders Fund, Lux Capital, 8VC, Shield Capital, and Decisive Point, among others. Global VC into defense/dual-use topped ~$15B in 2025 and is on pace to exceed ~$18B in 2026. This is equity capital — you trade ownership for money and, often, a board seat — so it complements (rather than replaces) non-dilutive grants. Note: raising equity can trigger CFIUS/foreign-ownership review for defense work; get advice before taking foreign capital.",
    source: "https://a16z.com/american-dynamism/"
  },
  {
    id: "strategic-investors",
    name: "Strategic Defense Investors (In-Q-Tel, NATO Innovation Fund)",
    funder: "In-Q-Tel · NATO Innovation Fund",
    dept: "Private / Alt",
    mechanism: "Venture Capital",
    capital: "Equity (dilutive)",
    award: "$500K–$2M",
    typical: "IQT ~$500K–$3M + a tech work agreement · NIF up to ~€15M",
    eligibility: "Tech that maps to a specific national-security capability gap (IQT) or an allied-nation nexus (NIF).",
    tech: ["AI / ML", "Cyber", "RF / Sensors", "Space", "Microelectronics", "Quantum"],
    desc: "Mission-driven strategic investors that back startups solving specific national-security problems — usually paired with a government pull.",
    detail: "In-Q-Tel (IQT) is the not-for-profit strategic investor chartered to back commercial startups whose technology serves the U.S. national-security community — roughly $500K–$3M per deal, usually paired with a technology-development work agreement and a board-observer seat. The NATO Innovation Fund (€1B, tickets up to ~€15M) invests in deep tech across its 24 allied nations. Both are equity and both require your technology to map to a stated capability need — they don't fund undifferentiated startups. NIF generally targets startups with an allied-nation nexus (the U.S. is not among its backing nations).",
    source: "https://www.iqt.org"
  },
  {
    id: "accelerators-equity",
    name: "Startup Accelerators (YC, Techstars, gener8tor)",
    funder: "Y Combinator · Techstars · gener8tor",
    dept: "Private / Alt",
    mechanism: "Accelerator (equity)",
    capital: "Equity (dilutive)",
    award: "$100K–$500K",
    typical: "YC $500K / ~7% · Techstars $220K / ~5% · ~3-month cohort",
    eligibility: "Early-stage startup accepted into a competitive cohort.",
    tech: ["AI / ML", "Autonomy / UAV", "Space", "RF / Sensors", "Advanced Materials"],
    desc: "Cash + mentorship + investor network in exchange for a small slice of equity — a fast on-ramp for very early teams.",
    detail: "Accelerators trade a standard amount of cash for a fixed equity stake plus a ~3-month program. Y Combinator's standard deal is $500K ($125K for 7% + $375K on an uncapped SAFE); Techstars invests $220K for ~5% and runs vertical programs including a Space accelerator with the U.S. Space Force and NASA JPL, plus a U.S. Air Force accelerator; gener8tor runs cohorts across many U.S. cities. Dilutive, but the network and customer access can be worth more than the check for a pre-seed team.",
    source: "https://www.ycombinator.com/about"
  },
  {
    id: "equity-crowdfunding",
    name: "Equity Crowdfunding (Reg CF / Reg A+)",
    funder: "Wefunder · StartEngine · Republic",
    dept: "Private / Alt",
    mechanism: "Crowdfunding",
    capital: "Equity (dilutive)",
    award: "$500K–$2M",
    typical: "Reg CF up to $5M/yr · Reg A+ Tier 2 up to $75M/yr",
    eligibility: "US company able to meet SEC disclosure (and, for Reg A+, audited financials).",
    tech: ["Autonomy / UAV", "Energy / Power", "Advanced Materials", "AI / ML"],
    desc: "Raise online from the public (accredited and non-accredited) via SEC exemptions — equity in exchange for capital and a crowd of backers.",
    detail: "SEC-registered portals (Wefunder, StartEngine, Republic) let you raise from the general public: Regulation CF allows up to $5M per 12 months; Regulation A+ Tier 2 up to $75M (requires SEC qualification and audited financials). It's dilutive and public — a strong fit for consumer-facing or community-backed dual-use products. Caveat for defense: a broad or foreign investor base can create ITAR/CFIUS and classified-work complications; structure the raise carefully.",
    source: "https://wefunder.com"
  },
  {
    id: "rewards-crowdfunding",
    name: "Rewards Crowdfunding (Kickstarter, Indiegogo)",
    funder: "Kickstarter · Indiegogo",
    dept: "Private / Alt",
    mechanism: "Crowdfunding",
    capital: "Rewards / pre-sales",
    award: "< $100K",
    typical: "No cap · all-or-nothing · ~8–10% platform + processing fees",
    eligibility: "Product with a pre-order / rewards narrative (best for dual-use consumer hardware).",
    tech: ["Energy / Power", "Autonomy / UAV", "Advanced Materials"],
    desc: "Pre-sell your product to backers for perks — non-dilutive and no debt, but you must deliver a product.",
    detail: "On Kickstarter and Indiegogo, backers pledge in exchange for the product or perks — not equity and not a loan, so it's fully non-dilutive. Both are all-or-nothing and charge roughly 8–10% all-in (platform + payment processing). It only fits products you can actually ship to a crowd, so it's a poor fit for classified or ITAR-restricted hardware but a good fit for dual-use, consumer-facing devices that double as market validation.",
    source: "https://www.kickstarter.com"
  },
  {
    id: "venture-debt",
    name: "Venture Debt / Revenue-Based Financing",
    funder: "Hercules · Lighter Capital · Arc · Capchase",
    dept: "Private / Alt",
    mechanism: "Venture Debt / RBF",
    capital: "Debt (non-dilutive)",
    award: "$2M–$15M",
    typical: "Hercules ~$5M–$200M · RBF up to ~$3M · all-in rates ~10–13%",
    eligibility: "Usually requires a prior institutional equity round or recurring revenue.",
    tech: ["AI / ML", "RF / Sensors", "Energy / Power", "Advanced Materials"],
    desc: "Borrow against your equity backing or recurring revenue to extend runway with minimal dilution.",
    detail: "Venture debt and revenue-based financing let you raise growth capital as debt rather than equity. Hercules Capital (facilities ~$5M–$200M, often with light warrant coverage) is the largest non-bank venture-debt lender; Lighter Capital, Arc, and Capchase offer smaller revenue-based or AR-backed facilities. All-in venture-debt rates run ~10–13% in 2026. Most lenders require an existing institutional equity round or predictable recurring revenue, so hardware/defense teams with long revenue cycles fit RBF poorly — better after a first equity round.",
    source: "https://www.htgc.com"
  },
  {
    id: "sba-loans",
    name: "SBA Loans (7(a) / 504) & SBIC Funds",
    funder: "U.S. Small Business Administration",
    dept: "Private / Alt",
    mechanism: "Loan / Loan Guarantee",
    capital: "Debt (non-dilutive)",
    award: "$2M–$15M",
    typical: "7(a) up to $5M · 504 up to $5.5M · combined up to $10M (2026)",
    eligibility: "For-profit US small business meeting SBA size/use standards.",
    tech: ["Advanced Materials", "Energy / Power", "Microelectronics"],
    desc: "Government-guaranteed loans through private lenders — debt for working capital or major fixed assets.",
    detail: "SBA-guaranteed 7(a) loans (up to $5M, general purpose) and 504 loans (up to $5.5M SBA portion, for real estate and heavy equipment) are made by approved lenders with an SBA guarantee. As of July 2026, qualified borrowers can combine 7(a) + 504 for up to $10M total. Separately, SBIC funds are SBA-licensed private funds that pair private capital with SBA leverage to invest equity and debt in small businesses — the capital reaches you through the fund, not the SBA directly.",
    source: "https://www.sba.gov/funding-programs/loans/7a-loans"
  },
  {
    id: "state-match",
    name: "State SBIR-Match & Regional Grants",
    funder: "State economic-development programs (e.g., MassVentures)",
    dept: "Private / Alt",
    mechanism: "State / Local Grant",
    capital: "Non-dilutive",
    award: "$100K–$500K",
    typical: "e.g. MassVentures START $100K / $200K / $500K by round",
    eligibility: "Company based in the state, often holding a federal SBIR/STTR award.",
    tech: ["AI / ML", "Advanced Materials", "Energy / Power", "Microelectronics"],
    desc: "State-level non-dilutive top-ups that stack on federal SBIR/STTR awards to accelerate commercialization.",
    detail: "Many states add non-dilutive money on top of a federal SBIR/STTR win. MassVentures START, for example, grants $100K / $200K / $500K across three rounds to Massachusetts firms with SBIR/STTR Phase II awards; other states (Texas via S.B. 209, plus Tennessee, Indiana, South Carolina and more) run match or Phase 0 programs. These are annual budget line items that change or pause, so confirm current status — the SSTI State SBIR/STTR Resource Guide (linked) is the best directory.",
    source: "https://ssti.org/state-sbirsttr-resource-guide"
  }
];
